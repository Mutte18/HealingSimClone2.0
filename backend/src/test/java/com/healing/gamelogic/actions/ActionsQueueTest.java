...
public class ActionsQueueTest {
    ...
    void shouldRemoveTopActionFromQueueWhenProcessed() {
        ...
        var action1 = new PlayerAction(new Player(0, 0, true, 0), new Dps(1, 1, true), new FlashHeal(), "1");
        var action2 = new PlayerAction(new Player(0, 0, true, 0), new Dps(1, 1, true), new FlashHeal(), "2");
