...
public class InputManager implements java.awt.event.KeyListener {
  ...
  public void keyPressed(KeyEvent e) {
    switch (e.getKeyCode()) {
      ...
      case KeyEvent.VK_1 -> castSpell(new FlashHeal().getSpellId(), "PLAYER0");
      case KeyEvent.VK_2 -> castSpell(new Renew().getSpellId(), "PLAYER0");
      case KeyEvent.VK_3 -> castSpell(new ChainHeal().getSpellId(), "PLAYER0");
      case KeyEvent.VK_4 -> castSpell(new Riptide().getSpellId(), "PLAYER0");
